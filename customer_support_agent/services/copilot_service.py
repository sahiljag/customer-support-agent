...
class SupportCopilot:
    ...
    def build_system_prompt(self, memory_hits: list[dict[str, Any]], kb_hits: list[dict[str, Any]]) -> str:
        return (
    ...
    def _extract_agent_draft_and_tool_calls(
        ...
        for message in messages:
            ...
            for call in pending_calls:
                ...
                parsed_output, output_text = self._parse_output(output_text)
                summary = self._tool_summary(parsed_output, output_text=output_text)
    ...
    def _build_context(
        ...
        return {
            ...
            "highlights": {
                ...
                "tools": [self._train_text(item.get("summary","")) for item in tool_calls[:3]],
            },
