...
@router.post("/api/tickets/{ticket_id}/generate-draft", response_model=GeneratedDraftResponse)
def generate_draft_route(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to generate draft: {exc}")
