...
class KnowledgeBaseService:
    ...
    def __init__(self, settings: Settings):
        ...
        self._collection = self._client.get_or_create_collection( name=self._collection_name, embedding_function=embedding_function, )
    ...
    def ingest_directory(
        ...
        for file_path in source_files:
            ...
            for index, chunk in enumerate(chunks):
                ...
                doc_id = (
                    f"{file_path.stem}-{index}-{chunk_hash}"
                )
